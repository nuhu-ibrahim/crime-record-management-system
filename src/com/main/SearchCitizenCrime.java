...
public class SearchCitizenCrime extends javax.swing.JPanel {

    public SearchCitizenCrime() {
    ...
    PoliceMenuPage main;
    public SearchCitizenCrime(PoliceMenuPage main) {
        this.main = main;
        DBConnection.connect();        
        initComponents();
    }
    ...
    CourtMenuPage main2;
    public SearchCitizenCrime(CourtMenuPage main) {
        this.main2 = main;
        DBConnection.connect();        
        initComponents();
    }
        ...
        table.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                try{
                    ...
                    if(main != null){
                        main.blur();
                        CrimeDeepInfo c= new CrimeDeepInfo(main, true, NIN.getText().trim(), SearchCitizenCrime.this, crimeName, crimeStatus, reportDate, occDate);
                        c.setLocationRelativeTo(null);
                        c.setVisible(true);
                    }else if(main2 != null){
                        main2.blur();
                        CrimeDeepInfo c= new CrimeDeepInfo(main2, true, NIN.getText().trim(), SearchCitizenCrime.this, crimeName, crimeStatus, reportDate, occDate);
                        c.setLocationRelativeTo(null);
                        c.setVisible(true);
                    }
