...
public class CourtCrimeDeepInfo extends javax.swing.JDialog {

    ViewActiveCases main;
    int crime_id;
    public CourtCrimeDeepInfo(java.awt.Frame parent, boolean modal, String NIN, ViewActiveCases main, String crimeName, String crimeStatus, String reportDate, String occDate) {
        super(parent, modal);
        this.main = main;
        initComponents();
        try{
    ...
    private void initComponents() {
        ...
        view_court_judgement.setText("Upload Court Judgement");
    ...
    private void view_court_judgementActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_view_court_judgementActionPerformed
        ProfileCourtInformation c= new ProfileCourtInformation(main.main, true, NIN.getText().trim(), crime_id);
