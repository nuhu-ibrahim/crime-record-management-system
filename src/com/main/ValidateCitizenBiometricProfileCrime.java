...
public class ValidateCitizenBiometricProfileCrime extends javax.swing.JDialog {
    ...
    private ProfileOffence main;
    private String NIN;
    public ValidateCitizenBiometricProfileCrime(java.awt.Frame parent, boolean modal, String NIN, ProfileOffence main) {
        super(parent, modal);
        this.main = main;
        this.NIN = NIN;
        initComponents();
